        ...
        const server = http.createServer((req, res) => {
            ...
            if (pathname === "/") {
                ...
                const wikiIndexPromise = graphData?.nodes[0]
                    ? fs.readFile(graphData.nodes[0].notePath.replace(/\/(meetings|whispers)\/.*$/, "/wiki/index.md"), "utf8").catch(() => undefined)
                ...
                req.on("end", () => {
                    ...
                    (async () => {
                        ...
                        try {
                            ...
                            log(`POST /note/speaker -> 200 (${isSingle ? "single@" + lineStart : "bulk"} ` +

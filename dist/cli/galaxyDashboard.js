...
async function main() {
    ...
    console.log(`[Galaxy Dashboard] building graph data from ${options.storageDir}`);
    const buildOptions = {
    ...
    console.log(`[Galaxy Dashboard] loaded ${graphData.nodes.length} nodes, ${graphData.edges.length} edges`);
...
//# sourceMappingURL=galaxyDashboard.js.map